...
def main():
    ...
    print(
        ...
        "  #\n"
        "  # docs/screenshot.png is not grabbed off this window at all:\n"
        "  # tools/shoot.py renders it from this fixture, on a display and a\n"
        "  # bus of its own, at exactly the size it is asked for:\n"
        f'  #   {REPO / "tools/shoot.py"} --fixture {root} --page library \\\n'
        "  #     --width 1180 --scale 1 --output docs/screenshot.png"
    )
    print()
